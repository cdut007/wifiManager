...
import com.thirdpart.model.WifiManager;
...
public class IssueConfirmActivity extends BaseEditActivity {
 ...
 @Override
	protected void onCreate(Bundle savedInstanceState) {
      ...
      initInfo();
      bindViews();
      issueManager = (WifiManager) ManagerService.getNewManagerService(this, WifiManager.class, this);
...
//		}
	...
	public void succ(String name, int statusCode, Header[] headers, Object response) {
		...
		if (name.equals(WifiManager.ACTION_ISSUE_CONFIRM)) {
			showToast("问题确认成功");
			setResult(RESULT_OK);
			finish();
		}
