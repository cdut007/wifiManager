package com.thirdpart.wifimanager.ui;
...
import com.thirdpart.wifimanager.adapter.WirelessAdapter;
import com.thirdpart.wifimanager.adapter.PlanAdapter;
...
public class DeliveryPlanFragment extends BasePageListFragment<RollingPlan, RollingPlanList> implements OnItemClickListener{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		bindListView(view,new WirelessAdapter(getBaseActivity()));
		...
		WirelessAdapter deliveryPlanAdapter = (WirelessAdapter) mAdapter;
